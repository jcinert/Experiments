...
for start_day in tqdm(['2016-01-01'], leave=True, desc='1st loop'): # test
    ...
    for params in tqdm(all_params, leave=True, desc='2nd loop'):
        ...
        df_cv = cross_validation(m_sweep, initial='2000 days', period='5 days', horizon = '10 days', parallel='threads') # TODO validate ig flat 2000 works?
...
# mlflow.log_metric("hello_metric", np.random.random_sample()) # TODO log gart or something?
mlflow.log_artifact("fbprophet_sweep.csv")